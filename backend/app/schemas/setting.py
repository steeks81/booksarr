...
class SettingsResponse(BaseModel):
    ...
    shelfmark_enabled: bool = False
    shelfmark_url: str = ""
    shelfmark_url_from_env: bool = False
    shelfmark_url_source: Literal["database", "environment", "none"] = "none"
    shelfmark_username: str = ""
    shelfmark_username_source: Literal["database", "environment", "none"] = "none"
    shelfmark_password_set: bool = False
    shelfmark_password_source: Literal["database", "environment", "none"] = "none"
    library_path: str
...
class SettingsUpdate(BaseModel):
    ...
    shelfmark_enabled: bool | None = None
    shelfmark_url: str | None = None
    shelfmark_username: str | None = None
    shelfmark_password: str | None = None
